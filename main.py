...
def carregar_dados(empresas):
    ...
    cotacoes_acao = dados_acao.history(period="1d", start="2016-01-01", end="2024-08-06")
...
if performance_carteira > 0:
        texto_performance_carteira = f"Perfeormance da carteira com todos os ativos: :green[{performance_carteira:.1%}]"
elif performance_carteira < 0:
        texto_performance_carteira = f"Perfeormance da carteira com todos os ativos: :red[{performance_carteira:.1%}]"
else:
        texto_performance_carteira = f"Perfeormance da carteira com todos os ativos:{performance_carteira:.1%}"


st.write(f"""
### Performance dos ativos
Performance dos ativos no periodo selecionado:
